...
//rimraf is a node module to remove a folder
//we use it to clean the build folder each time before re-creating it
import rimraf from 'rimraf';

//child_process is a node built-in package that allows us to run sub-processes like test.js
...
//$ will hold all gulp plugins without having to require them explicitly
